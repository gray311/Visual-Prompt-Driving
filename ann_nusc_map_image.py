...
map_api = nusc_map = NuScenesMap(dataroot='/media/yulongc/data/nuscenes/', map_name='singapore-onenorth')
...
if __name__ == "__main__":
    ...
    root = "/media/yulongc/data/nuscenes/samples/CAM_FRONT"
    
    from nuscenes.nuscenes import NuScenes
    nusc = NuScenes(version='v1.0-mini', verbose=False,dataroot='/media/yulongc/data/nuscenes')
    ...
    for layer_name in layer_names:
        for token in records_in_patch[layer_name]:
            ...
            for polygon_token in polygon_tokens:
                ...
                plt.gca().add_patch(descartes.PolygonPatch(polygon_proj, alpha=0.3, label=label))
