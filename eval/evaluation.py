...
def planning_evaluation(pred_trajs_dict, subset=None, only_vehicle=True):
    ...
    if only_vehicle:
        ...
        with open('./gt/vad_gt_seg.pkl','rb') as f:
    ...
    print("{:<15} {:<5} {:<5} {:<5} {:<5}".format(*method))
...
if __name__ == "__main__":
    ...
    """
    pred_trajs_dict = load_pred_trajs_from_file("./pred_trajs_dict.pkl")
    planning_evaluation(pred_trajs_dict, subset=None, only_vehicle=False)
